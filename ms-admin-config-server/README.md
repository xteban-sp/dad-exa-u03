...
- Configuracion de ejemplo por servicio/perfil:
  - `http://localhost:8888/ms-admin-api-gateway/dev`
  - `http://localhost:8888/ms-admin-registry-server/dev`
  - `http://localhost:8888/ms-gestion-instructor/dev`
  - `http://localhost:8888/ms-gestion-alumno/dev`
  - `http://localhost:8888/ms-gestion-taller/dev`
