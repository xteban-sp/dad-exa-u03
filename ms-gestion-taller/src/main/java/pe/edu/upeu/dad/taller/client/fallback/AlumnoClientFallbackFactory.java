    ...
    public AlumnoClient create(Throwable cause) {
        return new AlumnoClient() {
            ...
            public AlumnoDto incrementarTaller(Long id) {
                ...
                throw new IllegalStateException("ms-gestion-alumno no disponible (incrementar)");
            }
            ...
            public AlumnoDto decrementarTaller(Long id) {
                ...
                throw new IllegalStateException("ms-gestion-alumno no disponible (decrementar)");
            }
        };
    }
}
